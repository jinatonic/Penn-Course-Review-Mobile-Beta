...
import edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.impl.NoOpLog;
 ...
 *
 * @author Rod Waldhoff
 * @version $Id: LogSource.java,v 1.2 2012/03/22 21:02:04 mchyzer Exp $
 */
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("edu.upenn.isc.fastPdfServiceExt.org.apache.commons.logging.impl.Log4JLogger");
